...
Routes requests through OpenRouter's unified API to access GPT, Gemini,
DeepSeek, and other frontier models for market analysis.
"""
...
class OpenRouterClient(TradingLoggerMixin):
    ...
    def __init__(
        ...
        # base_url override lets us reuse this OpenAI-compatible client for any
        # OpenAI-style endpoint (e.g. DeepSeek's direct API) without a new class.
        self.base_url = base_url or settings.api.openrouter_base_url
