...
from src.utils.position_sizing import binary_market_payout_odds, dampen_confidence, kelly_fraction
    ...
    def _calculate_kelly_fractions(self, opportunities: List[MarketOpportunity]) -> Dict[str, float]:
        ...
        for opp in opportunities:
            try:
                ...
                win_prob = dampen_confidence(opp.predicted_probability, opp.market_probability)
